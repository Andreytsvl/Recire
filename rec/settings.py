...
# SECRET_KEY = 'django-insecure-8=j5*53aoxnr_8iit!_c^&-m(tw2kss#f$n*-etkvd@g!%3qm&'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'petrov85a$default',
        'USER': 'petrov85a',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'petrov85a.mysql.pythonanywhere-services.com',
        'OPTIONS': {
